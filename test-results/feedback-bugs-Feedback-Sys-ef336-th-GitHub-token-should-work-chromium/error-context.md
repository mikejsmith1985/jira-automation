  ...
  - generic [ref=e80]:
    ...
    - generic [ref=e84]:
      - generic [ref=e85]:
        ...
        - textbox "Brief description of the issue" [ref=e87]: Integration Test
      - generic [ref=e88]:
        - generic [ref=e89]: Description *
        - textbox "Please describe what happened, what you expected, and steps to reproduce..." [ref=e90]: Testing GitHub issue creation
      - generic [ref=e92]:
        - checkbox "Include logs (last 5 minutes) ✗ Logs will not be included" [ref=e93] [cursor=pointer]
        - generic [ref=e94]: Include logs (last 5 minutes)
        - generic [ref=e95]: ✗ Logs will not be included
      - generic [ref=e96]:
      ...
      - generic [ref=e99]:
        ...
        - button "Submitting..." [disabled] [ref=e101]
```