"""
GitHub scraper module - Playwright version
...
HOW IT WORKS:
1. Opens GitHub in a Chrome browser (controlled by Playwright)
...
class GitHubScraper:
    ...
    def __init__(self, page, config):
        ...
        Args:
            page: Playwright Page object (our "steering wheel")
            config: Dictionary with settings from config.yaml
        """
        self.page = page  # The browser page we'll use to visit GitHub
